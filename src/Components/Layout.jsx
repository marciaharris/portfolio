...
export default function Layout() {
    ...
    return (
        <div className="input-info text-secondary ">
            <div className="navbar border-accent border-2 rounded-lg bg-neutral">
                ...
                <div className="navbar-center">
                    <a className="btn btn-ghost text-xl">Marcia's Portfolio</a>
                </div>
