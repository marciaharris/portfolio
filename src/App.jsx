...
import Hackathon from './assets/photos/Challengers.png'
// import Clouds from './assets/videos/clouds.mov'
  ...
  return (
    <BrowserRouter>
      ...
      <Route path="/" element ={<Layout />}>
          ...
          <Route path="/Projects" element ={<Projects photos={Knights} tasks={Tasks} rick={Rick} challengers={Hackathon}/>}/>
